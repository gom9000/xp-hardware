...
## Thermal Model
Heat transfer in steady state is governed by Fourier's law of thermal conduction. Because its mathematical structure is identical to Ohm's law, heat flow through a medium can be modeled using an equivalent electrical circuit, where the temperature difference between any two nodes $A$ and $B$ is equivalent to voltage drop, and heat flow to current:
...
2. **Operating Point Adjustment**:
   ...
   * Fine-tune the $V_{CE}$ to lock $T_s$ exactly at $T_s^{\text{*}}$.

3. **Data Acquisition**:
   * Measure exact $V_{CE}$ and $I_C$ at equilibrium.
...
\**Notes: The base-drive power is neglected because it is small compared with the collector-emitter dissipation at the operating currents used in this experiment. All measurements must be performed with the heatsink oriented vertically.*


## Test Log
The circuit was tested using a **GVDA 30V/10A** switching laboratory power supply. Heatsink temperature was measured using a **GVDA GD128** multimeter, transistor $V_{CE}$ was measured with **FNIRSI 1014D** oscilloscope, and transistor $I_C$ was measured using a **MITEK MK6322** multimeter. Tests were conducted in a non-ventilated environment with an ambient temperature of $31\ ^\circ\text{C}$.

| ID / Geometry | Dimensions (WxDxH) [mm] | Weight [g] | Finish | $V_{CE}$ [V] | $I_C$ [A] | $P_D$ [W] | $T_a$ [$^{\circ}\text{C}$] | $T_s^*$ [$^{\circ}\text{C}$] | $\Theta_{sa}$ [$^{\circ}\text{C}/\text{W}$] |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **HS-01** | 15 x 10 x 22 | 2 | Silver | - | - | - | - | 60 | - |
| **HS-02** | 15 x 11 x 20 | 2 | Silver | 1.65 | 0.55 | 0.91 | 31 | 60 | 32 |
| **HS-03** | 15 x 11 x 20 | 2 | Black | 2.00 | 0.57 | 1.14 | 31 | 60 | 25 |
| **HS-04** | 23 x 17 x 25 | 10 | Black | 3.40 | 0.59 | 2.01 | 31 | 60 | 14.5 |
| **HS-05** | 32 x 10 x 36 | 12 | Silver/Raw | 3.41 | 0.61 | 2.08 | 31 | 60 | 14 |
| **HS-06** | 43 x 8 x 29 | 16 | Silver | 3.23 | 0.60 | 1.94 | 31 | 60 | 15 |
| **HS-07** | 28 x 13 x 33 | 15 | Black | 4.10 | 0.59 | 2.42 | 31 | 60 | 12 |
| **HS-08** | 23 x 17 x 25 | 18 | Black | 4.50 | 0.65 | 2.92 | 31 | 60 | 9.9 |
